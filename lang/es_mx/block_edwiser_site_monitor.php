...
$string['crontaskwarning'] = 'Para ver los datos de uso de 24 horas, necesitas ejecutar la tarea cron cada 5 minutos. Sigue este <a target="_blank" href="{$a}">enlace</a> para configurar cron.';
$string['today'] = 'Hoy';
$string['cannotshowonsidebar'] = 'No se puede mostrar el gráfico de uso en la barra lateral. Mueve el bloque a la región de contenido para ver el gráfico de uso.';
...
$string['privacy:metadata:block_edwiser_site_monitor:time'] = 'Hora en que se registró el uso.';
$string['privacy:metadata:block_edwiser_site_monitor:cpu'] = 'Uso de CPU del sitio cuando se registró.';
$string['privacy:metadata:block_edwiser_site_monitor:memory'] = 'Uso de memoria del sitio cuando se registró.';
$string['privacy:metadata:block_edwiser_site_monitor:storage'] = 'Uso de almacenamiento del sitio cuando se registró.';
...
$string['livestatusrefreshrate_invalid'] = 'Por favor proporciona una tasa de actualización válida en segundos';

$string['thresholdheader'] = 'Límite de umbral';
$string['usageemailsubject'] = '{$a}: Edwiser Site Monitor - Advertencia de uso';
...
$string['enablethreshold_help'] = 'Esto habilitará comprobaciones de umbral y enviará correos electrónicos si el uso es menor que el límite inferior o mayor que el límite superior';
...
$string['cpulimit_invalid'] = 'Por favor proporciona un límite de CPU válido';
$string['cpulimit_overlap'] = 'Por favor proporciona un límite de CPU válido. El límite superior no puede ser igual o menor que el límite inferior';
$string['cpucommandnotallowed'] = 'Línea de comando <strong>/proc/cpuinfo</strong> -- Permiso denegado.';
...
$string['memorylimit_invalid'] = 'Por favor proporciona un límite de memoria válido';
$string['memorylimit_overlap'] = 'Por favor proporciona un límite de memoria válido. El límite superior no puede ser igual o menor que el límite inferior';
$string['memorycommandnotallowed'] = 'Línea de comando <strong>free</strong> -- Permiso denegado.';
...
$string['storagelimit_invalid'] = 'Por favor proporciona un límite de almacenamiento válido';
$string['storagelimit_overlap'] = 'Por favor proporciona un límite de almacenamiento válido. El límite superior no puede ser igual o menor que el límite inferior';

// Plugin update list.
$string['errors'] = 'Errores';
$string['invalidzip'] = 'Archivo zip inválido. <b>{$a}</b>';
$string['errorfetching'] = 'Error al obtener el ZIP del plugin. <b>{$a}</b>';
$string['errorfetchingexist'] = 'Error al obtener el ZIP del plugin: el destino ya existe. <b>{$a}</b>';
$string['unabletounzip'] = 'No se pudo descomprimir <b>{$a}</b>';
$string['unabletoloadplugindetails'] = 'No se pudo cargar los detalles del plugin <b>{$a}</b>';
...
$string['comeswith'] = 'Incluido con: {$a}';
...
$string['checksettings'] = 'Por favor revisa <a target="_blank" href="{$a->link}">{$a->text}</a>';
