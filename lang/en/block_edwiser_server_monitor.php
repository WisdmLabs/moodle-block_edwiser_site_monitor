...
/**
 * Strings for component 'block_edwiser_server_monitor'.
 *
...
$string['configtitle'] = 'Edwiser Server Monitor block title';
$string['pluginname'] = 'Edwiser Server Monitor';
$string['privacy:metadata'] = 'The server monitor block shows information about server.';
...
$string['crontask'] = 'Edwiser Server Monitor - Collect 24 hours usage statistics';
$string['today'] = 'Today';
...
// Config page strings.
$string['block/edwiser_server_monitor:addinstance'] = 'Add a new server monitor block';
$string['block/edwiser_server_monitor:myaddinstance'] = 'Add a new server monitor to Dashboard';
